...
export default function StudentQuizPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-8">
      {loading ? (
        <div className="flex justify-center p-20"><Loader2 className="w-10 h-10 animate-spin" /></div>
        ...
        <>
          <div className="bg-white p-8 rounded-2xl shadow-lg border">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-4xl font-bold text-blue-600">{questions[currentIndex].word}</p>
            </div>
            
            <div className="flex justify-center gap-4 mb-8">
              <button onClick={() => speak(questions[currentIndex].word)} className="p-4 bg-blue-50 text-blue-600 rounded-full hover:bg-blue-100">
                <Volume2 size={32} />
              </button>
              <button 
                onClick={listen} 
